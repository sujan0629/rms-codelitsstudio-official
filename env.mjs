...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_STRIPE_ENTERPRISE_MONTHLY_PLAN_ID: z.string().min(1),
    NEXT_PUBLIC_STRIPE_ENTERPRISE_YEARLY_PLAN_ID: z.string().min(1),
  },
  runtimeEnv: {
    ...
    NEXT_PUBLIC_STRIPE_BASIC_MONTHLY_PLAN_ID:
      process.env.NEXT_PUBLIC_STRIPE_BASIC_MONTHLY_PLAN_ID,
    NEXT_PUBLIC_STRIPE_BASIC_YEARLY_PLAN_ID:
      process.env.NEXT_PUBLIC_STRIPE_BASIC_YEARLY_PLAN_ID,
    ...
    NEXT_PUBLIC_STRIPE_ENTERPRISE_MONTHLY_PLAN_ID:
      process.env.NEXT_PUBLIC_STRIPE_ENTERPRISE_MONTHLY_PLAN_ID,
    NEXT_PUBLIC_STRIPE_ENTERPRISE_YEARLY_PLAN_ID:
      process.env.NEXT_PUBLIC_STRIPE_ENTERPRISE_YEARLY_PLAN_ID,
  },
});
