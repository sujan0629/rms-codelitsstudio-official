  ...
  return (
    <section>
      <div className="container max-w-6xl flex flex-col gap-10 py-32 sm:gap-y-16">
        ...
        <div className="column-1 space-y-5 gap-5 md:columns-2 lg:columns-3">
                ...
                <div className="flex flex-col px-4 py-5 sm:p-6">
                  <div>
                    <div className="relative mb-4 flex items-center gap-3">
                      <span className="relative inline-flex shrink-0 size-16 items-center justify-center overflow-hidden rounded-full border">
                        <Image
                          src={item.image}
                          alt={item.name}
                          width={50}
