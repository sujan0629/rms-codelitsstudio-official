      ...
      <MaxWidthWrapper>
        <div className="relative z-10 grid grid-cols-6 gap-3">
          ...
          <div className="relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-2">
            <div className="relative m-auto size-fit">
              <div className="relative flex h-24 w-56 items-center">
                ...
                <span className="mx-auto block w-fit font-heading text-5xl text-gradient_gold">
                  100%
                </span>
              </div>
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
            <div>
              <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:before:border-yellow-600">
                <svg
                  className="m-auto h-fit w-24 text-yellow-600"
                  viewBox="0 0 212 143"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <defs>
                    ...
                    <clipPath id="clip0_0_1">
                      <rect width="129" height="72" transform="translate(41)" />
                    </clipPath>
                  </defs>
                  ...
                  <g clipPath="url(#clip0_0_1)">
                    <path
                      d="M44.0209 55.3542C43.1945 54.7639 … 141.417 128.135Z"
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  cls.RmS® securely integrates every aspect of your restaurant
                  — from inventory to staff management.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
            <div>
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                <h2 className="text-lg font-medium text-foreground">
                  Easy to Use, Built for Growth
                </h2>
                <p className="text-muted-foreground">
                  Get started in minutes. cls.RmS® makes running and growing
                  your restaurant effortless.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    cls.RmS® handles high-volume orders with ease. Never keep
                    customers waiting during peak hours.
                  </p>
                </div>
              </div>
              <div className="relative -mb-10 -mr-10 mt-8 h-fit rounded-tl-xl border bg-muted/30 pt-6 sm:ml-6 sm:mt-auto">
                ...
                <svg
                  className="w-full text-yellow-600/60 sm:w-[150%]"
                  viewBox="0 0 366 231"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-3">
            <div className="grid h-full sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  <h2 className="text-lg font-medium text-foreground">
                    Take Your Business to the Enterprise Level
                  </h2>
                  <p className="text-muted-foreground">
                    Empower your restaurant with advanced tools designed for
                    growth and scalability.
                  </p>
                </div>
              </div>
              <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-yellow-500/50 sm:-my-8 sm:-mr-8">
